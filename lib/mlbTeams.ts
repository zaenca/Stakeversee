...
export const MLB_TEAMS: MlbTeamProfile[] = [
  { id: "baltimore orioles", name: "Балтимор Ориолс", shortName: "Балтимор", league: "MLB", country: "США", logo: "BAL", rank: 1, form: "-", aliases: ["baltimore orioles", "baltimore", "orioles", "балтимор ориолс", "балтимор", "ориолс"] },
  { id: "boston red sox", name: "Бостон Ред Сокс", shortName: "Бостон", league: "MLB", country: "США", logo: "BOS", rank: 2, form: "-", aliases: ["boston red sox", "boston", "red sox", "бостон ред сокс", "бостон", "ред сокс"] },
  { id: "new york yankees", name: "Нью-Йорк Янкиз", shortName: "Янкиз", league: "MLB", country: "США", logo: "NYY", rank: 3, form: "-", aliases: ["new york yankees", "ny yankees", "yankees", "нью йорк янкиз", "нью-йорк янкиз", "янкиз"] },
  { id: "tampa bay rays", name: "Тампа-Бэй Рэйс", shortName: "Тампа-Бэй", league: "MLB", country: "США", logo: "TB", rank: 4, form: "-", aliases: ["tampa bay rays", "tampa bay", "rays", "тампа бэй рэйс", "тампа-бэй рэйс", "тампа бэй", "рэйс"] },
  ...
  { id: "chicago white sox", name: "Чикаго Уайт Сокс", shortName: "Уайт Сокс", league: "MLB", country: "США", logo: "CWS", rank: 6, form: "-", aliases: ["chicago white sox", "white sox", "chi white sox", "чикаго уайт сокс", "уайт сокс"] },
  { id: "cleveland guardians", name: "Кливленд Гардианс", shortName: "Кливленд", league: "MLB", country: "США", logo: "CLE", rank: 7, form: "-", aliases: ["cleveland guardians", "cleveland", "guardians", "кливленд гардианс", "кливленд", "гардианс"] },
  { id: "detroit tigers", name: "Детройт Тайгерс", shortName: "Детройт", league: "MLB", country: "США", logo: "DET", rank: 8, form: "-", aliases: ["detroit tigers", "detroit", "tigers", "детройт тайгерс", "детройт", "тайгерс"] },
  ...
  { id: "minnesota twins", name: "Миннесота Твинс", shortName: "Миннесота", league: "MLB", country: "США", logo: "MIN", rank: 10, form: "-", aliases: ["minnesota twins", "minnesota", "twins", "миннесота твинс", "миннесота", "твинс"] },
  ...
  { id: "houston astros", name: "Хьюстон Астрос", shortName: "Хьюстон", league: "MLB", country: "США", logo: "HOU", rank: 12, form: "-", aliases: ["houston astros", "houston", "astros", "хьюстон астрос", "хьюстон", "астрос"] },
  ...
  { id: "texas rangers", name: "Техас Рейнджерс", shortName: "Техас", league: "MLB", country: "США", logo: "TEX", rank: 15, form: "-", aliases: ["texas rangers", "texas", "rangers", "техас рейнджерс", "техас", "рейнджерс"] },
