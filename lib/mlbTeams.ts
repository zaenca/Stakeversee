...
export const MLB_TEAMS: MlbTeamProfile[] = [
  ...
  { id: "detroit tigers", name: "Детройт Тайгерс", shortName: "Детройт", league: "MLB", country: "США", logo: "DET", rank: 8, form: "-", aliases: ["detroit tigers", "detroit", "детройт тайгерс", "детройт"] },
