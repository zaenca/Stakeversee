...
export const translations: Record<string, string> = {
  ...
  "Идёт загрузка матчей": "Matches are loading",
  "По этому запросу матчи не найдены": "No matches found for this query",
  "Возможно, поиск ограничивает выдачу.": "The search query may be limiting the results.",
  "Очистить поиск": "Clear search",
  "Очки HLTV": "HLTV points",
  "Изменение": "Change",
  "топ-100": "top 100",
  ...
  "Убрать из чёрного списка": "Remove from blacklist",
